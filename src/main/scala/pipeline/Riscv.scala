...
object Riscv{
    ...
    case class IMM(instruction  : Bits) extends Area{
        ...
        def u = U"x00000000" ## instruction(31 downto 12) ## U"x000"   // 64 bits unsigned number
        def j = instruction(31) ## instruction(19 downto 12) ## instruction(20) ## instruction(30 downto 21)
        def z = instruction(19 downto 15)

        // sign-extend immediates 64 bits
        def i_sext = B((51 downto 0) -> i(11)) ## i
        def h_sext = B((55 downto 0) -> h(7))  ## h
        def s_sext = B((51 downto 0) -> s(11)) ## s
        def b_sext = B((50 downto 0) -> b(11)) ## b ## False   // now no need to shift left 1 bit
        def j_sext = B((42 downto 0) -> j(19)) ## j ## False
    }
    ...
    def isBType(opcode: Bits)   =   opcode === M"1100011"
    def isRType(opcode: Bits)   =   opcode === M"0110011" || opcode === M"0111011"
    def isIType(opcode: Bits)   =   opcode === M"0000011" || opcode === M"1100111" || opcode === M"0010011" || opcode === M"0011011"
    def isUType(opcode: Bits)   =   opcode === M"0110111" || opcode === M"0010111"
    ...
    def loadByte            = "000"
    def loadByteU           = "001"
    def loadHalfWord        = "010"
    def loadHalfWordU       = "011"
    def loadWord            = "100"
    def loadWordU           = "101"
    def loadDefault         = "111"
    ...
    def BEQ_funct3          = M"000"
    def BNE_funct3          = M"001"
    def BLT_funct3          = M"100"
    def BGE_funct3          = M"101"
    def BLTU_funct3         = M"110"
    def BGEU_funct3         = M"111"
