...
object Riscv{
    ...
    def bTypeOpcode        = M"1100011"
    def rTypeOpcode        = M"0110011"
    def rTypeOpcode64      = M"0111011"
    def loadOpcode         = M"0000011"

    def isBType(opcode: Bits)   =   opcode === M"1100011"
    def isRType(opcode: Bits)   =   opcode === M"0110011" || opcode === M"0111011"
    def isITyoe(opcode: Bits)   =   opcode === M"0000011" || opcode === M"1100111" || opcode === M"0010011" || opcode === M"0011011"
    def isUTYpe(opcode: Bits)   =   opcode === M"0110111"
