...
VL_MODULE(VControl) {
  public:
    ...
    static CData/*0:0*/ __Vtable1_ALUSrc[128];
    static CData/*0:0*/ __Vtable2_MemtoReg[128];
    static CData/*0:0*/ __Vtable3_RegWrite[128];
    static CData/*0:0*/ __Vtable4_MemRead[128];
    static CData/*0:0*/ __Vtable5_MemWrite[128];
    static CData/*0:0*/ __Vtable6_Branch[128];
    static CData/*1:0*/ __Vtable7_ALUop[128];
  ...
  public:
    static void _combo__TOP__1(VControl__Syms* __restrict vlSymsp);
  private:
